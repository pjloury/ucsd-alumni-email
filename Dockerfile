...
ENV LISTMONK_db__host=${PGHOST:-localhost}
ENV LISTMONK_db__port=${PGPORT:-5432}
ENV LISTMONK_db__user=${PGUSER:-listmonk}
ENV LISTMONK_db__password=${PGPASSWORD:-listmonk}
ENV LISTMONK_db__database=${PGDATABASE:-listmonk}
